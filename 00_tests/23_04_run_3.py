...
# %%
def main():
    folder_path_main = os.path.join(os.getcwd(), '01_out', 'sub_3')
    info_file_name = 'study_params_sub3.h5'
    
    #old_info_file_name = 'study_params_sub3_backup.h5'
    #_main_update_study_in_info_file(folder_path_main=folder_path_main, info_file_name=info_file_name, old_info_file_name=old_info_file_name)
    #sys.exit()
