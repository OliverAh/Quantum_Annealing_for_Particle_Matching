...
# %%
def main():
    folder_path_main = os.path.join(os.getcwd(), '01_out', 'sub_2')
    info_file_name = 'study_params_small.h5'
    ...
    for study in reread_info_file['info']['study']['data']:
        ...
        sp_update[id.decode('utf-8')]['kwargs_sampling'].update({name: study['sets'][name][0] for name in names})
